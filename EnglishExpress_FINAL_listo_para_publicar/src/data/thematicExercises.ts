...
import { translateVocabTerm, splitVocabFocus } from './vocabTranslations';
...
export function generateThematicExercises(
  ...
  const vocabWords = splitVocabFocus(sessionPlan.vocabFocus);
  ...
  // Traducciones reales al español de las 4 palabras de esta sesión.
  // Se usan como opciones de respuesta, para que el ejercicio pregunte
  // "¿cuál es el significado en español?" con opciones REALES, no relleno.
  const t1 = translateVocabTerm(v1);
  const t2 = translateVocabTerm(v2);
  const t3 = translateVocabTerm(v3);
  const t4 = translateVocabTerm(v4);
  ...
  const vocabExercises: Exercise[] = [
    {
      ...
      options: [t1, t2, t3, t4],
      acceptableAnswers: [t1, t1.toLowerCase()],
    ...
    },
    {
      ...
      audioText: v2,
      options: [t2, t1, t3, t4],
      acceptableAnswers: [t2, t2.toLowerCase()],
    ...
    },
    {
      ...
      audioText: v3,
      options: [t3, t1, t2, t4],
      acceptableAnswers: [t3, t3.toLowerCase()],
    ...
    },
    {
      ...
      audioText: v4,
      options: [t4, t1, t2, t3],
      acceptableAnswers: [t4, t4.toLowerCase()],
      mexicanTip: sessionPlan.culturalNote,
    ...
    },
    {
      ...
      vocabPairs: [
        { id: 'dvp1', english: v1, spanish: t1 },
        { id: 'dvp2', english: v2, spanish: t2 },
        { id: 'dvp3', english: v3, spanish: t3 },
        { id: 'dvp4', english: v4, spanish: t4 }
      ],
